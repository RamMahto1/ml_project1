...
class DataTransformation:
    ...
    def get_data_as_data_transformation(self):
        '''
    ...
    def initiate_data_transformer(self,train_path, test_path):
        try:
            ...
            preprocessing_obj = self.get_data_as_data_transformation()
            ...
            logging.info(f"applying preprocessor object on training and testing")
